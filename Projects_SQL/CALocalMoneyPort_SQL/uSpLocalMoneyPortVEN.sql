...
IF (@requestType='SENDALL')      
 ...
 emailBeneficiary,    
 sendIdAgency       
  FROM uVwItalcambioEnvioMoneda WHERE providerAcronym = @receiptProvider 
...
-- EXEC uSpLocalMoneyPortVEN '','',SENDALL,'','RY'       