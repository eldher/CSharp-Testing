...
INNER JOIN   mtagentsTransfast AT  ON  (AT.sBranchCountryCode = '10005' and AT.sBranchStateCode = 'NY' and AT.sModePayCode = '2' and AT.agente = 16899 and AT.sBranchCity='MIAMI' and TRB.Cod_Pais = 'USA')                   
...
AND T.finalOperation ='01290820147160003'
...
--AND T.finalOperation= '700290820147160004' -- solo para esta vez se pasara quemado este parametro
 ...
 --select * from tMoneySendtransaction where codsender= 'V4503765'   
 
 --select * from tlinksexchangeinstrument where operationtarget = '01290820147160003'
    
    
 --   select * from enlaces where operacioncierre = '21150820141540001'
 
 --select * from enlaces_cadivi where operacion = '21150820141540001'
 --select * from detalles_cadivi	where opercadivi = '21090420144900005'
 -- select * from planilla_cadivi where operacioncierre = '21090420144900005'   
...
--select * from tLinksExchangeInstrument tl  where operationSource='27240420144930002'
-- select * from tLinksExchangeInstrument tl  where operationSource='01290820147160005'
--01290820147160005



--select * from tMoneySendtransaction where codsender= 'V6562718'
--select * from tMoneySendtransaction where codsender= 'V4503765'
--select * from tMoneySendtransaction where codsender= 'V3968452'

--select * from planilla_cadiviespecial where auxiliar_sol= 'V3968452'
--select * from detalles_cadivi where opercadivi='27100120145100079'
--select * from enlaces_cadivi where operacioncierre='27100120145100079'
--select * from tLinksExchangeInstrument where operationtarget='27040220141540001'
--select * from transferenciaverificada where operacion='27040220141540001'