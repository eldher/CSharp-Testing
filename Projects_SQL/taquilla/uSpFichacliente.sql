 -----------------------------------------------------------------------                              
ALTER PROC [dbo].[uSpFichaCliente]                                          
/*                                            
...
BEGIN                                 
 ...
 BEGIN                                            
  SET @sqlText = 'Insert Into Clientes ( Auxiliar,                           
   ...
   Values (                                             
    ...
    '+char(39)+@SegundoNombre+char(39)+',                                      
     ''A'',                                      
     ''OCASIONAL'',                                    
     '+char(39)+@Comentarios+char(39)+',                    
     '+CHAR(39)+@Estado_Civil+CHAR(39)+',                     
     '+CHAR(39)+@Cargo+CHAR(39)+',                    
     '+CHAR(39)+@MotivoServicio+CHAR(39)+',                    
     '+CHAR(39)+@OrigenFondos+CHAR(39)+',                    
     '+CHAR(39)+@Correo+CHAR(39)+',                    
     '+CHAR(39)+@nombreRepLegal+CHAR(39)+',                    
     '+CHAR(39)+@cedulaRepLegal+CHAR(39)+',                    
     '+CHAR(39)+@tipoPoder+CHAR(39)+',                    
     '+CHAR(39)+@fechaVencPoder+CHAR(39)+',                    
     '+CHAR(39)+@paisODFondos+CHAR(39)+',                    
     '+CHAR(39)+@tipoCambio+CHAR(39)+',                    
     '+CHAR(39)+@equivalDivisas+CHAR(39)+',                    
     '+CHAR(39)+@montoDivisas+CHAR(39)+',                    
     '+CHAR(39)+@tipoOperacion+CHAR(39)+',      
     '+CHAR(39)+@TC_Numero+CHAR(39)+')'         
     --PRINT @sqltext                    
  EXEC (@sqltext)                                   
 ...
 PRINT @fechaVencPoder                                          
   SET @sqlText =                    
    'UPDATE Clientes SET                     
     Nombres = '+CHAR(39)+@Nombres+CHAR(39)+',                                            
    ...
    TipoBCV_Perfil = '+CHAR(39)+@TipoBCV_Perfil+CHAR(39)+',                                      
     ...
     comment = '+CHAR(39)+@Comentarios+CHAR(39)+',                    
     Estado_Civil = '+CHAR(39)+@Estado_Civil+CHAR(39)+',                     
     Cargo = '+CHAR(39)+@Cargo+CHAR(39)+',                    
     MotivoServicio = '+CHAR(39)+@MotivoServicio+CHAR(39)+',                    
     OrigenFondos  = '+CHAR(39)+@OrigenFondos+CHAR(39)+',                    
     Correo  = '+CHAR(39)+@Correo+CHAR(39)+',                    
     nombreRepLegal = '+CHAR(39)+@nombreRepLegal+CHAR(39)+',                    
     cedulaRepLegal = '+CHAR(39)+@cedulaRepLegal+CHAR(39)+',                    
     tipoPoder = '+CHAR(39)+@tipoPoder +CHAR(39)+',                    
     fechaVencPoder = '+CHAR(39)+@fechaVencPoder+CHAR(39)+',                    
     paisODFondos = '+CHAR(39)+@paisODFondos +CHAR(39)+',                    
     tipoCambio = '+ CONVERT(varchar(30),@tipoCambio)+',                    
     equivalDivisas = '+ CONVERT(varchar(30),@equivalDivisas)+',                    
     montoDivisas = '+ CONVERT(varchar(30),@montoDivisas)+',                    
     tipoOperacion = '+CHAR(39)+@tipoOperacion+CHAR(39)+'       
     TC_Numero = '+ CHAR(39)+ @TC_Numero +CHAR(39) +'                   
...
EXEC (@sqltext)                      
 ...
 BEGIN                                            
  ...
  ISNULL(Correo,'') as Correo,                    ISNULL(nombreRepLegal,'') as nombreRepLegal,                    
  ...
  ISNULL(CONVERT(varchar,tipoCambio),'') as tipoCambio,                    
  ISNULL(equivalDivisas,'') as equivalDivisas,                    
  ISNULL(montoDivisas,'') as montoDivisas,                    
