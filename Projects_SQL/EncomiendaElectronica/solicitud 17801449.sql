SELECT * FROM Trusadsolicitante WHERE solicitud ='17801449'

SELECT * FROM Trusadbeneficiario WHERE solicitud ='17801449'

SELECT * FROM Planilla_cadivi WHERE solicitud ='17801449'

SELECT * from Detalles_Cadivi where Opercadivi = '37230120144900071' 

SELECT * from Enlaces_Cadivi where operacioncierre = '37230120144900071' 

SELECT * FROM tLinksExchangeInstrument Where OperationSource='37030420141540001'
...
--SELECT * FROM tblrusadtransferencia WHERE auxiliarbenef = '17801449'
 ...
 EXEC uSpRetornaListaEncomiendasElectronicasESTCE 'JP','','','17801449','',0,'','' 
