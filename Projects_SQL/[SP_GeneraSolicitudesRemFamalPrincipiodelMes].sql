...
ALTER Procedure  [dbo].[SP_GeneraSolicitudesRemFamalPrincipiodelMes]              
as               
...
--**************************************************************************************************   
--Alter 11072014       
--Modificado por Eldher Hernandez, se modificaron las variables @Monto_BenefRB y @Monto_SolRS por @montoMaximoSol y @montoMaximoBenef
--**************************************************************************************************            
...
-- eldher hernandez 11/07/2014
declare @montoMaximoBenef money
select  @montoMaximoBenef = CAST(valor AS money) FROM PARAMETROS WHERE  Clave = 'REMESAS FAMILIARES'

--declare @montoMaximoSol money
--select  @montoMaximoSol = CAST(valor AS money) FROM PARAMETROS WHERE  Clave = 'max_providencia'
    ...
    FETCH NEXT FROM BENEF                
          ...
          SET @InstrumentoRB = 'II'    
                                 ...
                                 exec uSpRegistroBenefGA   @SolicitudRB, @Auxiliar_BenefRB, @BeneficiarioRB, @Auxiliar_SolRB, @ParentescoRB,                 
                                                @Dir_BenefRB, @Ciudad_BenefRB, @Pais_BenefRB, @ObservacionRB, @Usuario_TaqRB,                 
                                                @Requisitos_TaqRB, @InstrumentoRB, @EstadoRB, /*@Monto_BenefRB*/ @montoMaximoBenef, @fecha_residenciaRB, @FechaVencCartResi, @aux_rep,                 
                                                @rep_nom1, @rep_nom2, @rep_apellido1, @rep_apellido2, @divisaRB,                 
                                                /*@montodivisaRB*/@montoMaximoBenef, /*@tasaRB*/@tasaactual, @fixingRB, @destinoRB, @nombre_benef1, @nombre_benef2,                 
                        ...
                        BEGIN      
									...
									-- COLOCAMOS EL VALOR MAXIMO POR NUMERO DE BENEFICIARIOS
									declare @montoMaximoSol money
									set @montoMaximoSol = @montoMaximoBenef*@contabenef
                                  ...
                                  -- Generamos la Solicitud de Remesa Familiar                
                                    ...
                                    /*@Monto_SolRS*/ @montoMaximoSol, @agenciaactual, @CantidadBenefRS, @REVISADARS, @asistenciaplanillaRS, @Fecha_Residencia)                
                                   ...
                                   -- Generamos el script para replicar la Solicitud a la agencia correspondiente                
                                    ...
                                    +','+convert(varchar,/*@Monto_SolRS*/ @montoMaximoSol)+','+convert(varchar,@agenciaactual)                
